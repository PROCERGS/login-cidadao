...
namespace PROCERGS\LoginCidadao\NotificationBundle\EventListener;
...
class OAuthAuthorizationListener
{
    ...
    /** @var \PROCERGS\LoginCidadao\CoreBundle\Entity\PersonRepository */
    private $personRepo;
    ...
    {
        $this->personRepo = $em->getRepository('PROCERGSLoginCidadaoCoreBundle:Person');
