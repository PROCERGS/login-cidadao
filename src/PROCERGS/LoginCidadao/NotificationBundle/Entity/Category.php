...
class Category implements CategoryInterface, UniqueEntityInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="PROCERGS\LoginCidadao\NotificationBundle\Entity\PersonNotificationOption", mappedBy="category")
     */
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="PROCERGS\LoginCidadao\NotificationBundle\Entity\Placeholder", mappedBy="category")
     */
