...
class ShoutController extends Controller
{
    ...
    public function stepCategoryAction(Request $request)
    {
        ...
        $sql = $em->getRepository('LoginCidadaoNotificationBundle:Category')
    ...
    public function stepPlaceholderAction(Request $request)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $placeholders = $em->getRepository('LoginCidadaoNotificationBundle:Placeholder')
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $sql = $em->getRepository('LoginCidadaoCoreBundle:Notification\Shout')
