...
class PersonRepository extends EntityRepository
{
    ...
    public function getCountByCountry()
    {
      ...
      return $qb
              ...
              ->innerJoin('LoginCidadaoCoreBundle:Country', 'c', 'WITH', 'p.country = c')
    ...
    public function getCountByState()
    {
      ...
      return $qb
              ...
              ->from('LoginCidadaoCoreBundle:Person', 'p')
              ->innerJoin('LoginCidadaoCoreBundle:State', 's', 'WITH', 'p.state = s')
    ...
    public function getCountByCity($stateId)
    {
      ...
      return $qb
              ...
              ->from('LoginCidadaoCoreBundle:Person', 'p')
              ->innerJoin('LoginCidadaoCoreBundle:City', 'c', 'WITH', 'p.city = c')
