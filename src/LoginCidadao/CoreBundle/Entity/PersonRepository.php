...
class PersonRepository extends EntityRepository
{
    ...
    public function findAllPendingCPFUntilDate($date)
    {
        return $this->getEntityManager()
            ->createQuery(
                'SELECT p FROM LoginCidadaoCoreBundle:Person p WHERE p.cpf IS NULL AND p.cpfExpiration >= :date'
            )
    ...
    public function findUnconfirmedEmailUntilDate(\DateTime $dateLimit)
    {
        return $this->getEntityManager()
            ->createQuery(
                'SELECT p FROM LoginCidadaoCoreBundle:Person p WHERE p.confirmationToken IS NOT NULL AND p.emailExpiration <= :date'
            )
