...
use LoginCidadao\NotificationBundle\Entity\FailedCallback;
...
class NotificationHandler implements NotificationHandlerInterface
{
    ...
    /** @var \LoginCidadao\NotificationBundle\Entity\NotificationRepository */
    private $repository;
    private $formFactory;
    ...
    {
        $repo = $this->om->getRepository('LoginCidadaoNotificationBundle:PersonNotificationOption');
    ...
    public function markRangeAsRead(PersonInterface $person, $start, $end)
    {
        $om            = $this->om;
        $notifications = $om
            ->getRepository('LoginCidadaoNotificationBundle:Notification')
