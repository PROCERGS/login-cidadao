...
class NotificationsHelper
{
    ...
    {
        $category = $this->em->getRepository('LoginCidadaoNotificationBundle:Category')->findOneByUid($this->emptyPasswordCategoryId);
        if (null === $category) {
    ...
    /**
     *
     * @return \LoginCidadao\NotificationBundle\Handler\NotificationHandlerInterface
     */
