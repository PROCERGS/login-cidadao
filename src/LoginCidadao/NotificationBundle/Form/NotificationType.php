...
class NotificationType extends CommonFormType
{
        ...
        $preSubmit         = function(FormEvent $event) use (&$em) {
            ...
            $form
                ->add('person', 'entity',
                    NotificationType::getPreSubmitParams(
                        'LoginCidadaoCoreBundle:Person', 'id',
                ...
                ->add('category', 'entity',
                    NotificationType::getPreSubmitParams(
                        'LoginCidadaoNotificationBundle:Category', 'id',
            ...
            if (isset($data['category']) && isset($data['sender'])) {
                $category = $em
                    ...
                    ->getQuery()
                    ->setFetchMode('LoginCidadaoNotificationBundle:Placeholder',
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'LoginCidadao\NotificationBundle\Entity\Notification',
    ...
    public static function getPersonQuery($data)
    {
        ...
        $query    = function(EntityRepository $er) use ($id, $clientId) {
            return $er->createQueryBuilder('p')
                    ->innerJoin('LoginCidadaoCoreBundle:Authorization',
